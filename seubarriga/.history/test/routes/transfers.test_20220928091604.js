...
describe('When trying to update an invalid transfer...', () => {
  ...
  const template = (newData, errorMessage) => {     
    const data = {...dataTransfer, ...newData};
    console.log('->', data);
  ...
  test('Should not Update Transfer without description', () =>
    template({ description: null }, 'The description is a required attribute')
  );

  test('Should not Update Transfer without ammount', () => 
    template({ ammount: null }, 'The ammount is a required attribute')  
  );

  test('Should not Update Transfer without date', () => 
    template({ date: null }, 'The date is a required attribute')  
  );

  test('Should not Update Transfer without originating account', () => {
    template({ acc_ori_id: null }, 'The originating account is a required attribute')  
  });

  test('Should not Update Transfer without destination account', () => {
    template({ acc_des_id: null }, 'The destination account is a required attribute')  
  });

  test('Should not Update Transfer if account origin and destiny as equal', () => 
    template({ acc_des_id: 10000 }, 'The account origin and destiny cannot equal')
  );

  test('Should not Update Transfer if an account is another user', () => 
    template({ user_id: 10001 }, 'Accounts belong to another user')
  );
