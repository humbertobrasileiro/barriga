...
module.exports = (app) => {
  ...
  const update = async (id, transfer) => {
    ...
    if (transfer.date === undefined) transfer.date = result[0].date;
    if (transfer.ammount === undefined) transfer.ammount = result[0].ammount;
    if (transfer.acc_ori_id === undefined) transfer.acc_ori_id = result[0].acc_ori_id;
    if (transfer.acc_des_id === undefined) transfer.acc_des_id = result[0].acc_des_id;
